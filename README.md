...
This is an MCP (Model Context Protocol) server that provides access to the Nikola TEST - NewsAPI API. It enables AI agents and LLMs to interact with Nikola TEST - NewsAPI through standardized tools.

## Features

- 🔧 **MCP Protocol**: Built on the Model Context Protocol for seamless AI integration
- 🌐 **Full API Access**: Provides tools for interacting with Nikola TEST - NewsAPI endpoints
- 🐳 **Docker Support**: Easy deployment with Docker and Docker Compose
- ⚡ **Async Operations**: Built with FastMCP for efficient async handling

## API Documentation

- **Nikola TEST - NewsAPI Website**: [https://newsapi.org/v2](https://newsapi.org/v2)
- **API Documentation**: [https://newsapi.org/docs](https://newsapi.org/docs)
...
*Note: Replace `example_tool` with actual Nikola TEST - NewsAPI API tools based on the documentation.*
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/nikola-test-newsapi-mcp-server.git
   cd nikola-test-newsapi-mcp-server
   ```
...
1. Create API client functions for Nikola TEST - NewsAPI endpoints
...
```json
{
  "github_url": "https://github.com/Traia-IO/nikola-test-newsapi-mcp-server",
  "mcp_server": {
    "name": "nikola-test-newsapi-mcp",
    "description": "Search and retrieve live news articles from over 80,000 sources worldwide - breaking news, headlines, and historical articles",
